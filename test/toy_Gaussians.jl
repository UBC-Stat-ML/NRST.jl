...
#
# ISSUES RAISED
# - Multithreaded touring NRST does not give uniform distribution over levels under exact c(b) = F(b)
#     - single thread touring has no issue
# - Multithreaded touring NRST produces incorrect estimates of E^{b}[V]
#     - single thread touring has no issue
###############################################################################

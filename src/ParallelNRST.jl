...
function parallel_run!(
    ...
    # init storage: vector of tuples, each one containing the tour id plus the
    # output of a single call to tour!
    trace = Tuple{Int, Vector{T}, Vector{MVector{2,I}}}[]
    ...
    Threads.@threads for tour in 1:ntours
        ...
        push!(trace, (tour, xtrace, iptrace))
